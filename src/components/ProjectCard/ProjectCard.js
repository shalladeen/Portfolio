...
const ProjectCard = () => {
  return (
    <Container maxW="container.xl" centerContent>
      <SimpleGrid columns={[1, null, 2]} spacing={10} alignItems="center" justifyContent="center">
          ...
          <Box as="a" href={project.projectUrl} target="_blank"
            ...
            <VStack align="center" spacing={4} flex="1">
              ...
              <VStack align="start" spacing={1} flexGrow="1">
                ...
                <Text fontSize="sm" align="start" maxWidth="300px">{project.description}</Text>
              </VStack>
            </VStack>
            <IconButton
              aria-label="Github Link" icon={<FiGithub />} isRound={true} size="lg" 
              position="absolute" bottom={5} right={5}
              colorScheme="gray" _hover={{ bg: 'gray.600', color: 'white' }}
